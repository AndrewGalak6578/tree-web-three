...
import { SUI_TYPE_ARG as ct, Coin as E0, JsonRpcProvider as ut, Connection as lt, getSuiObjectData as bt, getMoveObject as G0, fromSerializedSignature as dt, messageWithIntent as yt, IntentScope as vt, fromB64 as gt } from "@mysten/sui.js";
class wt {
  constructor(x, o) {
    Bf(this, "provider");
    Bf(this, "address");
...
(function(s) {
  (function(x) {
    ...
    function ft(t, e, r, f) {
      for (var n = f[0] & 255 | (f[1] & 255) << 8 | (f[2] & 255) << 16 | (f[3] & 255) << 24, a = r[0] & 255 | (r[1] & 255) << 8 | (r[2] & 255) << 16 | (r[3] & 255) << 24, h = r[4] & 255 | (r[5] & 255) << 8 | (r[6] & 255) << 16 | (r[7] & 255) << 24, b = r[8] & 255 | (r[9] & 255) << 8 | (r[10] & 255) << 16 | (r[11] & 255) << 24, w = r[12] & 255 | (r[13] & 255) << 8 | (r[14] & 255) << 16 | (r[15] & 255) << 24, L = f[4] & 255 | (f[5] & 255) << 8 | (f[6] & 255) << 16 | (f[7] & 255) << 24, E = e[0] & 255 | (e[1] & 255) << 8 | (e[2] & 255) << 16 | (e[3] & 255) << 24, J = e[4] & 255 | (e[5] & 255) << 8 | (e[6] & 255) << 16 | (e[7] & 255) << 24, S = e[8] & 255 | (e[9] & 255) << 8 | (e[10] & 255) << 16 | (e[11] & 255) << 24, O = e[12] & 255 | (e[13] & 255) << 8 | (e[14] & 255) << 16 | (e[15] & 255) << 24, C = f[8] & 255 | (f[9] & 255) << 8 | (f[10] & 255) << 16 | (f[11] & 255) << 24, D = r[16] & 255 | (r[17] & 255) << 8 | (r[18] & 255) << 16 | (r[19] & 255) << 24, z = r[20] & 255 | (r[21] & 255) << 8 | (r[22] & 255) << 16 | (r[23] & 255) << 24, Y = r[24] & 255 | (r[25] & 255) << 8 | (r[26] & 255) << 16 | (r[27] & 255) << 24, P = r[28] & 255 | (r[29] & 255) << 8 | (r[30] & 255) << 16 | (r[31] & 255) << 24, R = f[12] & 255 | (f[13] & 255) << 8 | (f[14] & 255) << 16 | (f[15] & 255) << 24, U = n, M = a, B = h, j = b, T = w, p = L, c = E, u = J, v = S, l = O, d = C, g = D, I = z, H = Y, $ = P, F = R, i, X = 0; X < 20; X += 2)
      ...
      U = U + n | 0, M = M + a | 0, B = B + h | 0, j = j + b | 0, T = T + w | 0, p = p + L | 0, c = c + E | 0, u = u + J | 0, v = v + S | 0, l = l + O | 0, d = d + C | 0, g = g + D | 0, I = I + z | 0, H = H + Y | 0, $ = $ + P | 0, F = F + R | 0, t[0] = U >>> 0 & 255, t[1] = U >>> 8 & 255, t[2] = U >>> 16 & 255, t[3] = U >>> 24 & 255, t[4] = M >>> 0 & 255, t[5] = M >>> 8 & 255, t[6] = M >>> 16 & 255, t[7] = M >>> 24 & 255, t[8] = B >>> 0 & 255, t[9] = B >>> 8 & 255, t[10] = B >>> 16 & 255, t[11] = B >>> 24 & 255, t[12] = j >>> 0 & 255, t[13] = j >>> 8 & 255, t[14] = j >>> 16 & 255, t[15] = j >>> 24 & 255, t[16] = T >>> 0 & 255, t[17] = T >>> 8 & 255, t[18] = T >>> 16 & 255, t[19] = T >>> 24 & 255, t[20] = p >>> 0 & 255, t[21] = p >>> 8 & 255, t[22] = p >>> 16 & 255, t[23] = p >>> 24 & 255, t[24] = c >>> 0 & 255, t[25] = c >>> 8 & 255, t[26] = c >>> 16 & 255, t[27] = c >>> 24 & 255, t[28] = u >>> 0 & 255, t[29] = u >>> 8 & 255, t[30] = u >>> 16 & 255, t[31] = u >>> 24 & 255, t[32] = v >>> 0 & 255, t[33] = v >>> 8 & 255, t[34] = v >>> 16 & 255, t[35] = v >>> 24 & 255, t[36] = l >>> 0 & 255, t[37] = l >>> 8 & 255, t[38] = l >>> 16 & 255, t[39] = l >>> 24 & 255, t[40] = d >>> 0 & 255, t[41] = d >>> 8 & 255, t[42] = d >>> 16 & 255, t[43] = d >>> 24 & 255, t[44] = g >>> 0 & 255, t[45] = g >>> 8 & 255, t[46] = g >>> 16 & 255, t[47] = g >>> 24 & 255, t[48] = I >>> 0 & 255, t[49] = I >>> 8 & 255, t[50] = I >>> 16 & 255, t[51] = I >>> 24 & 255, t[52] = H >>> 0 & 255, t[53] = H >>> 8 & 255, t[54] = H >>> 16 & 255, t[55] = H >>> 24 & 255, t[56] = $ >>> 0 & 255, t[57] = $ >>> 8 & 255, t[58] = $ >>> 16 & 255, t[59] = $ >>> 24 & 255, t[60] = F >>> 0 & 255, t[61] = F >>> 8 & 255, t[62] = F >>> 16 & 255, t[63] = F >>> 24 & 255;
    }
    function tt(t, e, r, f) {
      for (var n = f[0] & 255 | (f[1] & 255) << 8 | (f[2] & 255) << 16 | (f[3] & 255) << 24, a = r[0] & 255 | (r[1] & 255) << 8 | (r[2] & 255) << 16 | (r[3] & 255) << 24, h = r[4] & 255 | (r[5] & 255) << 8 | (r[6] & 255) << 16 | (r[7] & 255) << 24, b = r[8] & 255 | (r[9] & 255) << 8 | (r[10] & 255) << 16 | (r[11] & 255) << 24, w = r[12] & 255 | (r[13] & 255) << 8 | (r[14] & 255) << 16 | (r[15] & 255) << 24, L = f[4] & 255 | (f[5] & 255) << 8 | (f[6] & 255) << 16 | (f[7] & 255) << 24, E = e[0] & 255 | (e[1] & 255) << 8 | (e[2] & 255) << 16 | (e[3] & 255) << 24, J = e[4] & 255 | (e[5] & 255) << 8 | (e[6] & 255) << 16 | (e[7] & 255) << 24, S = e[8] & 255 | (e[9] & 255) << 8 | (e[10] & 255) << 16 | (e[11] & 255) << 24, O = e[12] & 255 | (e[13] & 255) << 8 | (e[14] & 255) << 16 | (e[15] & 255) << 24, C = f[8] & 255 | (f[9] & 255) << 8 | (f[10] & 255) << 16 | (f[11] & 255) << 24, D = r[16] & 255 | (r[17] & 255) << 8 | (r[18] & 255) << 16 | (r[19] & 255) << 24, z = r[20] & 255 | (r[21] & 255) << 8 | (r[22] & 255) << 16 | (r[23] & 255) << 24, Y = r[24] & 255 | (r[25] & 255) << 8 | (r[26] & 255) << 16 | (r[27] & 255) << 24, P = r[28] & 255 | (r[29] & 255) << 8 | (r[30] & 255) << 16 | (r[31] & 255) << 24, R = f[12] & 255 | (f[13] & 255) << 8 | (f[14] & 255) << 16 | (f[15] & 255) << 24, U = n, M = a, B = h, j = b, T = w, p = L, c = E, u = J, v = S, l = O, d = C, g = D, I = z, H = Y, $ = P, F = R, i, X = 0; X < 20; X += 2)
        i = U + I | 0, T ^= i << 7 | i >>> 32 - 7, i = T + U | 0, v ^= i << 9 | i >>> 32 - 9, i = v + T | 0, I ^= i << 13 | i >>> 32 - 13, i = I + v | 0, U ^= i << 18 | i >>> 32 - 18, i = p + M | 0, l ^= i << 7 | i >>> 32 - 7, i = l + p | 0, H ^= i << 9 | i >>> 32 - 9, i = H + l | 0, M ^= i << 13 | i >>> 32 - 13, i = M + H | 0, p ^= i << 18 | i >>> 32 - 18, i = d + c | 0, $ ^= i << 7 | i >>> 32 - 7, i = $ + d | 0, B ^= i << 9 | i >>> 32 - 9, i = B + $ | 0, c ^= i << 13 | i >>> 32 - 13, i = c + B | 0, d ^= i << 18 | i >>> 32 - 18, i = F + g | 0, j ^= i << 7 | i >>> 32 - 7, i = j + F | 0, u ^= i << 9 | i >>> 32 - 9, i = u + j | 0, g ^= i << 13 | i >>> 32 - 13, i = g + u | 0, F ^= i << 18 | i >>> 32 - 18, i = U + j | 0, M ^= i << 7 | i >>> 32 - 7, i = M + U | 0, B ^= i << 9 | i >>> 32 - 9, i = B + M | 0, j ^= i << 13 | i >>> 32 - 13, i = j + B | 0, U ^= i << 18 | i >>> 32 - 18, i = p + T | 0, c ^= i << 7 | i >>> 32 - 7, i = c + p | 0, u ^= i << 9 | i >>> 32 - 9, i = u + c | 0, T ^= i << 13 | i >>> 32 - 13, i = T + u | 0, p ^= i << 18 | i >>> 32 - 18, i = d + l | 0, g ^= i << 7 | i >>> 32 - 7, i = g + d | 0, v ^= i << 9 | i >>> 32 - 9, i = v + g | 0, l ^= i << 13 | i >>> 32 - 13, i = l + v | 0, d ^= i << 18 | i >>> 32 - 18, i = F + $ | 0, I ^= i << 7 | i >>> 32 - 7, i = I + F | 0, H ^= i << 9 | i >>> 32 - 9, i = H + I | 0, $ ^= i << 13 | i >>> 32 - 13, i = $ + H | 0, F ^= i << 18 | i >>> 32 - 18;
    ...
    Xf.prototype.blocks = function(t, e, r) {
      for (var f = this.fin ? 0 : 2048, n, a, h, b, w, L, E, J, S, O, C, D, z, Y, P, R, U, M, B, j = this.h[0], T = this.h[1], p = this.h[2], c = this.h[3], u = this.h[4], v = this.h[5], l = this.h[6], d = this.h[7], g = this.h[8], I = this.h[9], H = this.r[0], $ = this.r[1], F = this.r[2], i = this.r[3], X = this.r[4], Q = this.r[5], m = this.r[6], G = this.r[7], W = this.r[8], V = this.r[9]; r >= 16; )
        n = t[e + 0] & 255 | (t[e + 1] & 255) << 8, j += n & 8191, a = t[e + 2] & 255 | (t[e + 3] & 255) << 8, T += (n >>> 13 | a << 3) & 8191, h = t[e + 4] & 255 | (t[e + 5] & 255) << 8, p += (a >>> 10 | h << 6) & 8191, b = t[e + 6] & 255 | (t[e + 7] & 255) << 8, c += (h >>> 7 | b << 9) & 8191, w = t[e + 8] & 255 | (t[e + 9] & 255) << 8, u += (b >>> 4 | w << 12) & 8191, v += w >>> 1 & 8191, L = t[e + 10] & 255 | (t[e + 11] & 255) << 8, l += (w >>> 14 | L << 2) & 8191, E = t[e + 12] & 255 | (t[e + 13] & 255) << 8, d += (L >>> 11 | E << 5) & 8191, J = t[e + 14] & 255 | (t[e + 15] & 255) << 8, g += (E >>> 8 | J << 8) & 8191, I += J >>> 5 | f, S = 0, O = S, O += j * H, O += T * (5 * V), O += p * (5 * W), O += c * (5 * G), O += u * (5 * m), S = O >>> 13, O &= 8191, O += v * (5 * Q), O += l * (5 * X), O += d * (5 * i), O += g * (5 * F), O += I * (5 * $), S += O >>> 13, O &= 8191, C = S, C += j * $, C += T * H, C += p * (5 * V), C += c * (5 * W), C += u * (5 * G), S = C >>> 13, C &= 8191, C += v * (5 * m), C += l * (5 * Q), C += d * (5 * X), C += g * (5 * i), C += I * (5 * F), S += C >>> 13, C &= 8191, D = S, D += j * F, D += T * $, D += p * H, D += c * (5 * V), D += u * (5 * W), S = D >>> 13, D &= 8191, D += v * (5 * G), D += l * (5 * m), D += d * (5 * Q), D += g * (5 * X), D += I * (5 * i), S += D >>> 13, D &= 8191, z = S, z += j * i, z += T * F, z += p * $, z += c * H, z += u * (5 * V), S = z >>> 13, z &= 8191, z += v * (5 * W), z += l * (5 * G), z += d * (5 * m), z += g * (5 * Q), z += I * (5 * X), S += z >>> 13, z &= 8191, Y = S, Y += j * X, Y += T * i, Y += p * F, Y += c * $, Y += u * H, S = Y >>> 13, Y &= 8191, Y += v * (5 * V), Y += l * (5 * W), Y += d * (5 * G), Y += g * (5 * m), Y += I * (5 * Q), S += Y >>> 13, Y &= 8191, P = S, P += j * Q, P += T * X, P += p * i, P += c * F, P += u * $, S = P >>> 13, P &= 8191, P += v * H, P += l * (5 * V), P += d * (5 * W), P += g * (5 * G), P += I * (5 * m), S += P >>> 13, P &= 8191, R = S, R += j * m, R += T * Q, R += p * X, R += c * i, R += u * F, S = R >>> 13, R &= 8191, R += v * $, R += l * H, R += d * (5 * V), R += g * (5 * W), R += I * (5 * G), S += R >>> 13, R &= 8191, U = S, U += j * G, U += T * m, U += p * Q, U += c * X, U += u * i, S = U >>> 13, U &= 8191, U += v * F, U += l * $, U += d * H, U += g * (5 * V), U += I * (5 * W), S += U >>> 13, U &= 8191, M = S, M += j * W, M += T * G, M += p * m, M += c * Q, M += u * X, S = M >>> 13, M &= 8191, M += v * i, M += l * F, M += d * $, M += g * H, M += I * (5 * V), S += M >>> 13, M &= 8191, B = S, B += j * V, B += T * W, B += p * G, B += c * m, B += u * Q, S = B >>> 13, B &= 8191, B += v * X, B += l * i, B += d * F, B += g * $, B += I * H, S += B >>> 13, B &= 8191, S = (S << 2) + S | 0, S = S + O | 0, O = S & 8191, S = S >>> 13, C += S, j = O, T = C, p = D, c = z, u = Y, v = P, l = R, d = U, g = M, I = B, e += 16, r -= 16;
    ...
    function q(t, e, r) {
      var f, n, a = 0, h = 0, b = 0, w = 0, L = 0, E = 0, J = 0, S = 0, O = 0, C = 0, D = 0, z = 0, Y = 0, P = 0, R = 0, U = 0, M = 0, B = 0, j = 0, T = 0, p = 0, c = 0, u = 0, v = 0, l = 0, d = 0, g = 0, I = 0, H = 0, $ = 0, F = 0, i = r[0], X = r[1], Q = r[2], m = r[3], G = r[4], W = r[5], V = r[6], af = r[7], k = r[8], xf = r[9], of = r[10], sf = r[11], cf = r[12], bf = r[13], df = r[14], yf = r[15];
      f = e[0], a += f * i, h += f * X, b += f * Q, w += f * m, L += f * G, E += f * W, J += f * V, S += f * af, O += f * k, C += f * xf, D += f * of, z += f * sf, Y += f * cf, P += f * bf, R += f * df, U += f * yf, f = e[1], h += f * i, b += f * X, w += f * Q, L += f * m, E += f * G, J += f * W, S += f * V, O += f * af, C += f * k, D += f * xf, z += f * of, Y += f * sf, P += f * cf, R += f * bf, U += f * df, M += f * yf, f = e[2], b += f * i, w += f * X, L += f * Q, E += f * m, J += f * G, S += f * W, O += f * V, C += f * af, D += f * k, z += f * xf, Y += f * of, P += f * sf, R += f * cf, U += f * bf, M += f * df, B += f * yf, f = e[3], w += f * i, L += f * X, E += f * Q, J += f * m, S += f * G, O += f * W, C += f * V, D += f * af, z += f * k, Y += f * xf, P += f * of, R += f * sf, U += f * cf, M += f * bf, B += f * df, j += f * yf, f = e[4], L += f * i, E += f * X, J += f * Q, S += f * m, O += f * G, C += f * W, D += f * V, z += f * af, Y += f * k, P += f * xf, R += f * of, U += f * sf, M += f * cf, B += f * bf, j += f * df, T += f * yf, f = e[5], E += f * i, J += f * X, S += f * Q, O += f * m, C += f * G, D += f * W, z += f * V, Y += f * af, P += f * k, R += f * xf, U += f * of, M += f * sf, B += f * cf, j += f * bf, T += f * df, p += f * yf, f = e[6], J += f * i, S += f * X, O += f * Q, C += f * m, D += f * G, z += f * W, Y += f * V, P += f * af, R += f * k, U += f * xf, M += f * of, B += f * sf, j += f * cf, T += f * bf, p += f * df, c += f * yf, f = e[7], S += f * i, O += f * X, C += f * Q, D += f * m, z += f * G, Y += f * W, P += f * V, R += f * af, U += f * k, M += f * xf, B += f * of, j += f * sf, T += f * cf, p += f * bf, c += f * df, u += f * yf, f = e[8], O += f * i, C += f * X, D += f * Q, z += f * m, Y += f * G, P += f * W, R += f * V, U += f * af, M += f * k, B += f * xf, j += f * of, T += f * sf, p += f * cf, c += f * bf, u += f * df, v += f * yf, f = e[9], C += f * i, D += f * X, z += f * Q, Y += f * m, P += f * G, R += f * W, U += f * V, M += f * af, B += f * k, j += f * xf, T += f * of, p += f * sf, c += f * cf, u += f * bf, v += f * df, l += f * yf, f = e[10], D += f * i, z += f * X, Y += f * Q, P += f * m, R += f * G, U += f * W, M += f * V, B += f * af, j += f * k, T += f * xf, p += f * of, c += f * sf, u += f * cf, v += f * bf, l += f * df, d += f * yf, f = e[11], z += f * i, Y += f * X, P += f * Q, R += f * m, U += f * G, M += f * W, B += f * V, j += f * af, T += f * k, p += f * xf, c += f * of, u += f * sf, v += f * cf, l += f * bf, d += f * df, g += f * yf, f = e[12], Y += f * i, P += f * X, R += f * Q, U += f * m, M += f * G, B += f * W, j += f * V, T += f * af, p += f * k, c += f * xf, u += f * of, v += f * sf, l += f * cf, d += f * bf, g += f * df, I += f * yf, f = e[13], P += f * i, R += f * X, U += f * Q, M += f * m, B += f * G, j += f * W, T += f * V, p += f * af, c += f * k, u += f * xf, v += f * of, l += f * sf, d += f * cf, g += f * bf, I += f * df, H += f * yf, f = e[14], R += f * i, U += f * X, M += f * Q, B += f * m, j += f * G, T += f * W, p += f * V, c += f * af, u += f * k, v += f * xf, l += f * of, d += f * sf, g += f * cf, I += f * bf, H += f * df, $ += f * yf, f = e[15], U += f * i, M += f * X, B += f * Q, j += f * m, T += f * G, p += f * W, c += f * V, u += f * af, v += f * k, l += f * xf, d += f * of, g += f * sf, I += f * cf, H += f * bf, $ += f * df, F += f * yf, a += 38 * M, h += 38 * B, b += 38 * j, w += 38 * T, L += 38 * p, E += 38 * c, J += 38 * u, S += 38 * v, O += 38 * l, C += 38 * d, D += 38 * g, z += 38 * I, Y += 38 * H, P += 38 * $, R += 38 * F, n = 1, f = a + n + 65535, n = Math.floor(f / 65536), a = f - n * 65536, f = h + n + 65535, n = Math.floor(f / 65536), h = f - n * 65536, f = b + n + 65535, n = Math.floor(f / 65536), b = f - n * 65536, f = w + n + 65535, n = Math.floor(f / 65536), w = f - n * 65536, f = L + n + 65535, n = Math.floor(f / 65536), L = f - n * 65536, f = E + n + 65535, n = Math.floor(f / 65536), E = f - n * 65536, f = J + n + 65535, n = Math.floor(f / 65536), J = f - n * 65536, f = S + n + 65535, n = Math.floor(f / 65536), S = f - n * 65536, f = O + n + 65535, n = Math.floor(f / 65536), O = f - n * 65536, f = C + n + 65535, n = Math.floor(f / 65536), C = f - n * 65536, f = D + n + 65535, n = Math.floor(f / 65536), D = f - n * 65536, f = z + n + 65535, n = Math.floor(f / 65536), z = f - n * 65536, f = Y + n + 65535, n = Math.floor(f / 65536), Y = f - n * 65536, f = P + n + 65535, n = Math.floor(f / 65536), P = f - n * 65536, f = R + n + 65535, n = Math.floor(f / 65536), R = f - n * 65536, f = U + n + 65535, n = Math.floor(f / 65536), U = f - n * 65536, a += n - 1 + 37 * (n - 1), n = 1, f = a + n + 65535, n = Math.floor(f / 65536), a = f - n * 65536, f = h + n + 65535, n = Math.floor(f / 65536), h = f - n * 65536, f = b + n + 65535, n = Math.floor(f / 65536), b = f - n * 65536, f = w + n + 65535, n = Math.floor(f / 65536), w = f - n * 65536, f = L + n + 65535, n = Math.floor(f / 65536), L = f - n * 65536, f = E + n + 65535, n = Math.floor(f / 65536), E = f - n * 65536, f = J + n + 65535, n = Math.floor(f / 65536), J = f - n * 65536, f = S + n + 65535, n = Math.floor(f / 65536), S = f - n * 65536, f = O + n + 65535, n = Math.floor(f / 65536), O = f - n * 65536, f = C + n + 65535, n = Math.floor(f / 65536), C = f - n * 65536, f = D + n + 65535, n = Math.floor(f / 65536), D = f - n * 65536, f = z + n + 65535, n = Math.floor(f / 65536), z = f - n * 65536, f = Y + n + 65535, n = Math.floor(f / 65536), Y = f - n * 65536, f = P + n + 65535, n = Math.floor(f / 65536), P = f - n * 65536, f = R + n + 65535, n = Math.floor(f / 65536), R = f - n * 65536, f = U + n + 65535, n = Math.floor(f / 65536), U = f - n * 65536, a += n - 1 + 37 * (n - 1), t[0] = a, t[1] = h, t[2] = b, t[3] = w, t[4] = L, t[5] = E, t[6] = J, t[7] = S, t[8] = O, t[9] = C, t[10] = D, t[11] = z, t[12] = Y, t[13] = P, t[14] = R, t[15] = U;
    }
    function pf(t, e) {
      q(t, e, e);
    }
    ...
    function z0(t, e, r, f) {
      for (var n = new Int32Array(16), a = new Int32Array(16), h, b, w, L, E, J, S, O, C, D, z, Y, P, R, U, M, B, j, T, p, c, u, v, l, d, g, I = t[0], H = t[1], $ = t[2], F = t[3], i = t[4], X = t[5], Q = t[6], m = t[7], G = e[0], W = e[1], V = e[2], af = e[3], k = e[4], xf = e[5], of = e[6], sf = e[7], cf = 0; f >= 128; ) {
        for (T = 0; T < 16; T++)
          p = 8 * T + cf, n[T] = r[p + 0] << 24 | r[p + 1] << 16 | r[p + 2] << 8 | r[p + 3], a[T] = r[p + 4] << 24 | r[p + 5] << 16 | r[p + 6] << 8 | r[p + 7];
        for (T = 0; T < 80; T++)
          if (h = I, b = H, w = $, L = F, E = i, J = X, S = Q, O = m, C = G, D = W, z = V, Y = af, P = k, R = xf, U = of, M = sf, c = m, u = sf, v = u & 65535, l = u >>> 16, d = c & 65535, g = c >>> 16, c = (i >>> 14 | k << 32 - 14) ^ (i >>> 18 | k << 32 - 18) ^ (k >>> 41 - 32 | i << 32 - (41 - 32)), u = (k >>> 14 | i << 32 - 14) ^ (k >>> 18 | i << 32 - 18) ^ (i >>> 41 - 32 | k << 32 - (41 - 32)), v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, c = i & X ^ ~i & Q, u = k & xf ^ ~k & of, v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, c = P0[T * 2], u = P0[T * 2 + 1], v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, c = n[T % 16], u = a[T % 16], v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, l += v >>> 16, d += l >>> 16, g += d >>> 16, B = d & 65535 | g << 16, j = v & 65535 | l << 16, c = B, u = j, v = u & 65535, l = u >>> 16, d = c & 65535, g = c >>> 16, c = (I >>> 28 | G << 32 - 28) ^ (G >>> 34 - 32 | I << 32 - (34 - 32)) ^ (G >>> 39 - 32 | I << 32 - (39 - 32)), u = (G >>> 28 | I << 32 - 28) ^ (I >>> 34 - 32 | G << 32 - (34 - 32)) ^ (I >>> 39 - 32 | G << 32 - (39 - 32)), v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, c = I & H ^ I & $ ^ H & $, u = G & W ^ G & V ^ W & V, v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, l += v >>> 16, d += l >>> 16, g += d >>> 16, O = d & 65535 | g << 16, M = v & 65535 | l << 16, c = L, u = Y, v = u & 65535, l = u >>> 16, d = c & 65535, g = c >>> 16, c = B, u = j, v += u & 65535, l += u >>> 16, d += c & 65535, g += c >>> 16, l += v >>> 16, d += l >>> 16, g += d >>> 16, L = d & 65535 | g << 16, Y = v & 65535 | l << 16, H = h, $ = b, F = w, i = L, X = E, Q = J, m = S, I = O, W = C, V = D, af = z, k = Y, xf = P, of = R, sf = U, G = M, T % 16 === 15)
            for (p = 0; p < 16; p++)
    ...
    function Mf(t, e, r) {
      ...
      for (f[0] = 1779033703, f[1] = 3144134277, f[2] = 1013904242, f[3] = 2773480762, f[4] = 1359893119, f[5] = 2600822924, f[6] = 528734635, f[7] = 1541459225, n[0] = 4089235720, n[1] = 2227873595, n[2] = 4271175723, n[3] = 1595750129, n[4] = 2917565137, n[5] = 725511199, n[6] = 4215389547, n[7] = 327033209, z0(f, n, e, r), r %= 128, h = 0; h < r; h++)
        a[h] = e[b - r + h];
      for (a[r] = 128, r = 256 - 128 * (r < 112 ? 1 : 0), a[r - 9] = 0, nf(a, r - 8, b / 536870912 | 0, b << 3), z0(f, n, a, r), h = 0; h < 8; h++)
        nf(t, 8 * h, f[h], n[h]);
      return 0;
    }
    function Vf(t, e) {
    ...
    function h0(t, e, r) {
      ...
      for (Sf(t[0], N), Sf(t[1], K), Sf(t[2], K), Sf(t[3], N), n = 255; n >= 0; --n)
        f = r[n / 8 | 0] >> (n & 7) & 1, D0(t, e, f), Vf(e, t), Vf(t, t), D0(t, e, f);
    }
    function Jf(t, e) {
      var r = [o(), o(), o(), o()];
    ...
    var d0 = 32, mf = 24, Pf = 32, Cf = 16, zf = 32, kf = 32, Df = 32, Hf = 32, y0 = 32, F0 = mf, it = Pf, ot = Cf, Uf = 64, If = 32, Yf = 64, v0 = 32, g0 = 64;
    x.lowlevel = {
      ...
      crypto_scalarmult_BYTES: zf,
      crypto_scalarmult_SCALARBYTES: kf,
      crypto_box_PUBLICKEYBYTES: Df,
    ...
    x.randomBytes = function(t) {
      ...
      return qf(e, t), e;
    }, x.scalarMult.scalarLength = kf, x.scalarMult.groupElementLength = zf, x.box = function(t, e, r, f) {
      ...
      var t = new Uint8Array(Df), e = new Uint8Array(Hf);
    ...
    }, x.box.publicKeyLength = Df, x.box.secretKeyLength = Hf, x.box.sharedKeyLength = y0, x.box.nonceLength = F0, x.box.overheadLength = x.secretbox.overheadLength, x.sign = function(t, e) {
...
const Dt = (s, x) => BigInt(s >>> 0) << S0 | BigInt(x >>> 0), Ht = (s, x, o) => s >>> o, Ft = (s, x, o) => s << 32 - o | x >>> o, $t = (s, x, o) => s >>> o | x << 32 - o, Kt = (s, x, o) => s << 32 - o | x >>> o, Gt = (s, x, o) => s << 64 - o | x >>> o - 32, Xt = (s, x, o) => s >>> o - 32 | x << 64 - o, Zt = (s, x) => x, qt = (s, x) => s, Wt = (s, x, o) => s << o | x >>> 32 - o, Vt = (s, x, o) => x << o | s >>> 32 - o, Jt = (s, x, o) => x << o - 32 | s >>> 64 - o, Qt = (s, x, o) => s << o - 32 | x >>> 64 - o;
function mt(s, x, o, y) {
  const _ = (x >>> 0) + (y >>> 0);
